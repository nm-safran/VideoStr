...
const USERS = [ 
  ...
  { id: "IQS02_1042_Rawan", username: "IQS02_1042_Rawan", password: "IQS02_1042", name: "Rawan",    courses: ["c1"], lessonAccess: { c1: ["l2", "l3", "l4", "l5", "l6"] } },
  { id: "IQS02_1068_Mitzie Ocan", username: "IQS02_1068_Mitzie Ocan", password: "IQS02_1068", name: "Mitzie Ocan",    courses: ["c1"], lessonAccess: { c1: ["l2", "l3", "l4", "l5", "l6"] } },
  ...
  { id: "IQS02_1031_Shafat", username: "IQS02_1031_Shafat", password: "IQS02_1031", name: "Shafat",    courses: ["c1"], lessonAccess: { c1: ["l2", "l4", "l5", "l6"] } },
  ...
  { id: "APC36_1648_Michael Qaisiyeh", username: "APC36_1648_Michael Qaisiyeh", password: "APC36_1648", name: "Michael Qaisiyeh",    courses: ["c1"], lessonAccess: { c1: ["l3", "l5", "l6"] } },
  { id: "AQS30_1424_ Abayomi", username: "AQS30_1424_ Abayomi", password: "AQS30_1424", name: "Abayomi",    courses: ["c1"], lessonAccess: { c1: ["l3", "l5", "l6"] } },
  { id: "IQS02_1038_Aadhil Feroz", username: "IQS02_1038_Aadhil Feroz", password: "IQS02_1038", name: "Aadhil Feroz",    courses: ["c1"], lessonAccess: { c1: ["l3", "l4", "l5", "l6"] } },
  
  
// access for tender session
  { id: "IQS02_1039_Leslie Ashlyn	Leslie Ashlyn", username: "IQS02_1039_Leslie Ashlyn", password: "IQS02_1039", name: "Leslie Ashlyn",    courses: ["c1"], lessonAccess: { c1: ["l4", "l5", "l6"] } },
  { id: "IQS02_1043_Ammar", username: "IQS02_1043_Ammar", password: "IQS02_1043", name: "Ammar",    courses: ["c1"], lessonAccess: { c1: ["l4", "l5", "l6"] } },
  ...
  { id: "AQS26_1074_Fazal", username: "AQS26_1074_Fazal", password: "AQS26_1074", name: "Fazal",    courses: ["c1"], lessonAccess: { c1: ["l4", "l5", "l6"] } },
  { id: "APC16_1060_Mirghani Othman", username: "APC16_1060_Mirghani Othman", password: "APC16_1060", name: "Mirghani Othman",    courses: ["c1"], lessonAccess: { c1: ["l4", "l5", "l6"] } },
  { id: "IQS02_1033_Seeth", username: "IQS02_1033_Seeth", password: "IQS02_1033", name: "Seeth",    courses: ["c1"], lessonAccess: { c1: ["l4", "l5", "l6"] } }, 
  { id: "IQS02_1034_Yathurshan", username: "IQS02_1034_Yathurshan", password: "IQS02_1034", name: "Yathurshan",    courses: ["c1"], lessonAccess: { c1: ["l4", "l5", "l6"] } },
  { id: "AQS37_1668_Rasul", username: "AQS37_1668_Rasul", password: "AQS37_1668", name: "Rasul",    courses: ["c1"], lessonAccess: { c1: ["l4", "l5", "l6"] } },
  { id: "IQS02_1035_Rameez", username: "IQS02_1035_Rameez", password: "IQS02_1035", name: "Rameez",    courses: ["c1"], lessonAccess: { c1: ["l4", "l5", "l6"] } },
  { id: "APC37_1676_Milhan", username: "APC37_1676_Milhan", password: "APC37_1676", name: "Milhan",    courses: ["c1"], lessonAccess: { c1: ["l4", "l5", "l3", "l6"] } },
  { id: "IQS02_1037_Shakir", username: "IQS02_1037_Shakir", password: "IQS02_1037", name: "Shakir",    courses: ["c1"], lessonAccess: { c1: ["l4", "l5", "l6"] } },
  { id: "MEP05_1642_Ancy Joseph", username: "MEP05_1642_Ancy Joseph", password: "MEP05_1642", name: "Ancy Joseph",    courses: ["c1"], lessonAccess: { c1: ["l4", "l5", "l6"] } },
  { id: "IQS02_1040_Mohammad Insaf", username: "IQS02_1040_Mohammad Insaf", password: "IQS02_1040", name: "Mohammad Insaf",    courses: ["c1"], lessonAccess: { c1: ["l4", "l5", "l6"] } },
  { id: "IQS02_1041_Hisbu Rahman", username: "IQS02_1041_Hisbu Rahman", password: "IQS02_1041", name: "Hisbu Rahman",    courses: ["c1"], lessonAccess: { c1: ["l4", "l5", "l6"] } },
  { id: "IQS02_1044_Ahmad Faizan", username: "IQS02_1044_Ahmad Faizan", password: "IQS02_1044", name: "Ahmad Faizan",    courses: ["c1"], lessonAccess: { c1: ["l4", "l5", "l6"] } },
  ...
  { id: "AQS38_1697_Ashraf Faroqui", username: "AQS38_1697_Ashraf Faroqui", password: "AQS38_1697", name: "Ashraf Faroqui",    courses: ["c1"], lessonAccess: { c1: ["l4", "l5", "l6"] } },
  { id: "IQS02_1054_Aseef Ali	", username: "IQS02_1054_Aseef Ali", password: "IQS02_1054", name: "Aseef Ali",    courses: ["c1"], lessonAccess: { c1: ["l4", "l5", "l6"] } },
  { id: "IQS02_1052_Fathima", username: "IQS02_1052_Fathima", password: "IQS02_1052", name: "Fathima",    courses: ["c1"], lessonAccess: { c1: ["l4", "l5", "l6"] } },
  { id: "IQS02_1056_Fathima Raha", username: "IQS02_1056_Fathima Raha", password: "IQS02_1056", name: "Fathima Raha",    courses: ["c1"], lessonAccess: { c1: ["l4", "l5", "l6"] } },
  ...
  { id: "AQS35_1613_Anand Brahmbhatt", username: "AQS35_1613_Anand Brahmbhatt", password: "AQS35_1613", name: "Anand Brahmbhatt",    courses: ["c1"], lessonAccess: { c1: ["l4", "l5", "l6"] } },
  { id: "IQS02_1072_Alhussein Mahmoud Ali Ahmed", username: "IQS02_1072_Alhussein Mahmoud Ali Ahmed", password: "IQS02_1072", name: "Alhussein Mahmoud Ali Ahmed",    courses: ["c1"], lessonAccess: { c1: ["l4", "l5", "l6"] } },
  { id: "AQS37_1685_Aqueel", username: "AQS37_1685_Aqueel", password: "AQS37_1685", name: "Aqueel",    courses: ["c1"], lessonAccess: { c1: ["l4", "l5", "l6"] } },
  { id: "IQS02_1078_Safnas", username: "IQS02_1078_Safnas", password: "IQS02_1078", name: "Safnas",    courses: ["c1"], lessonAccess: { c1: ["l4", "l5", "l6"] } },
  { id: "APC27_1113_Shafeek Faiz", username: "APC27_1113_Shafeek Faiz", password: "APC27_1113", name: "Shafeek Faiz",    courses: ["c1"], lessonAccess: { c1: ["l4", "l5", "l6"] } },
  { id: "AQS36_1645_Dhanushka Chathuranga", username: "AQS36_1645_Dhanushka Chathuranga", password: "AQS36_1645", name: "Dhanushka Chathuranga",    courses: ["c1"], lessonAccess: { c1: ["l4", "l5", "l6"] } },
  { id: "IQS02_1080_Safardeen", username: "IQS02_1080_Safardeen", password: "IQS02_1080", name: "Safardeen wahabdeen",    courses: ["c1"], lessonAccess: { c1: ["l4", "l5", "l6"] } },
