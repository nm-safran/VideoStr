...
const USERS = [
  ...
  { id: "AQS37_1652_Taufique", username: "AQS37_1652_Taufique", password: "AQS37_1652", name: "Taufique",    courses: ["c1"], lessonAccess: { c1: ["l2"] } },
  { id: "AQS35_1616_Fareed", username: "AQS35_1616_Fareed", password: "AQS35_1616", name: "Fareed",    courses: ["c1"], lessonAccess: { c1: ["l2"] } },
  { id: "IQS02_1032_Samuel Nartey", username: "IQS02_1032_Samuel Nartey", password: "IQS02_1032", name: "Samuel Nartey",    courses: ["c1"], lessonAccess: { c1: ["l2"] } },
  { id: "AQS26_1074_Fazal", username: "AQS26_1074_Fazal", password: "AQS26_1074", name: "Fazal",    courses: ["c1"], lessonAccess: { c1: ["l2"] } },
  { id: "APC16_1060_Mirghani Othman", username: "APC16_1060_Mirghani Othman", password: "APC16_1060", name: "Mirghani Othman",    courses: ["c1"], lessonAccess: { c1: ["l2"] } },
  { id: "IQS02_1033_Seeth", username: "IQS02_1033_Seeth", password: "IQS02_1033", name: "Seeth",    courses: ["c1"], lessonAccess: { c1: ["l2"] } }, 
  { id: "IQS02_1034_Yathurshan", username: "IQS02_1034_Yathurshan", password: "IQS02_1034", name: "Yathurshan",    courses: ["c1"], lessonAccess: { c1: ["l2"] } },
  { id: "AQS37_1668_Rasul", username: "AQS37_1668_Rasul", password: "AQS37_1668", name: "Rasul",    courses: ["c1"], lessonAccess: { c1: ["l2"] } },
  { id: "IQS02_1035_Rameez", username: "IQS02_1035_Rameez", password: "IQS02_1035", name: "Rameez",    courses: ["c1"], lessonAccess: { c1: ["l2"] } },
  ...
  { id: "APC37_1676_Milhan", username: "APC37_1676_Milhan", password: "APC37_1676", name: "Milhan",    courses: ["c1"], lessonAccess: { c1: ["l2"] } },
  { id: "IQS02_1037_Shakir", username: "IQS02_1037_Shakir", password: "IQS02_1037", name: "Shakir",    courses: ["c1"], lessonAccess: { c1: ["l2"] } },
  { id: "MEP05_1642_Ancy Joseph", username: "MEP05_1642_Ancy Joseph", password: "MEP05_1642", name: "Ancy Joseph",    courses: ["c1"], lessonAccess: { c1: ["l2"] } },
  { id: "IQS02_1038_Aadhil Feroz", username: "IQS02_1038_Aadhil Feroz", password: "IQS02_1038", name: "Aadhil Feroz",    courses: ["c1"], lessonAccess: { c1: ["l2"] } },
  { id: "IQS02_1040_Mohammad Insaf", username: "IQS02_1040_Mohammad Insaf", password: "IQS02_1040", name: "Mohammad Insaf",    courses: ["c1"], lessonAccess: { c1: ["l2"] } },
  { id: "IQS02_1041_Hisbu Rahman", username: "IQS02_1041_Hisbu Rahman", password: "IQS02_1041", name: "Hisbu Rahman",    courses: ["c1"], lessonAccess: { c1: ["l2"] } },
  ...
  { id: "IQS02_1044_Ahmad Faizan", username: "IQS02_1044_Ahmad Faizan", password: "IQS02_1044", name: "Ahmad Faizan",    courses: ["c1"], lessonAccess: { c1: ["l2"] } },
  { id: "IQS02_1045_Мuhammad Ali", username: "IQS02_1045_Мuhammad Ali", password: "IQS02_1045", name: "Мuhammad Ali",    courses: ["c1"], lessonAccess: { c1: ["l2"] } },
  ...
  { id: "AQS38_1697_Ashraf Faroqui", username: "AQS38_1697_Ashraf Faroqui", password: "AQS38_1697", name: "Ashraf Faroqui",    courses: ["c1"], lessonAccess: { c1: ["l2"] } },
  { id: "IQS02_1054_Aseef Ali	", username: "IQS02_1054_Aseef Ali", password: "IQS02_1054", name: "Aseef Ali",    courses: ["c1"], lessonAccess: { c1: ["l2"] } },
  { id: "IQS02_1052_Fathima", username: "IQS02_1052_Fathima", password: "IQS02_1052", name: "Fathima",    courses: ["c1"], lessonAccess: { c1: ["l2"] } },
  { id: "IQS02_1056_Fathima Raha", username: "IQS02_1056_Fathima Raha", password: "IQS02_1056", name: "Fathima Raha",    courses: ["c1"], lessonAccess: { c1: ["l2"] } },
  { id: "IQS02_1059_Ahmed Askari", username: "IQS02_1059_Ahmed Askari", password: "IQS02_1059", name: "Ahmed Askari",    courses: ["c1"], lessonAccess: { c1: ["l2"] } },
  { id: "IQS02_1060_Virgilio", username: "IQS02_1060_Virgilio", password: "IQS02_1060", name: "Virgilio",    courses: ["c1"], lessonAccess: { c1: ["l2"] } },
  { id: "IQS02_1062_Prabu Sankar Yathindran", username: "IQS02_1062_Prabu Sankar Yathindran", password: "IQS02_1062", name: "Prabu Sankar Yathindran",    courses: ["c1"], lessonAccess: { c1: ["l2"] } },
  { id: "APC37_1687_Praveen", username: "APC37_1687_Praveen", password: "APC37_1687", name: "Praveen",    courses: ["c1"], lessonAccess: { c1: ["l2"] } },
  ...
  { id: "IQS02_1064_Azar", username: "IQS02_1064_Azar", password: "IQS02_1064", name: "Azar",    courses: ["c1"], lessonAccess: { c1: ["l2"] } },
  { id: "IQS02_1069_Nabeel Wali", username: "IQS02_1069_Nabeel Wali", password: "IQS02_1069", name: "Nabeel Wali",    courses: ["c1"], lessonAccess: { c1: ["l2"] } },
  { id: "APC33_1547_Harsan Sasny", username: "APC33_1547_Harsan Sasny", password: "APC33_1547", name: "Harsan Sasny",    courses: ["c1"], lessonAccess: { c1: ["l2"] } },
  { id: "AQS36_1630_Nafeer", username: "AQS36_1630_Nafeer", password: "AQS36_1630", name: "Nafeer",    courses: ["c1"], lessonAccess: { c1: ["l2"] } },
  { id: "APC34_1592_Javeed", username: "APC34_1592_Javeed", password: "APC34_1592", name: "Javeed",    courses: ["c1"], lessonAccess: { c1: ["l2"] } },
  { id: "AQS33_1545_Abdul Wasi", username: "AQS33_1545_Abdul Wasi", password: "AQS33_1545", name: "Abdul Wasi",    courses: ["c1"], lessonAccess: { c1: ["l2"] } },
  { id: "APC37_1649_Asham", username: "APC37_1649_Asham", password: "APC37_1649", name: "Asham",    courses: ["c1"], lessonAccess: { c1: ["l2"] } },
  ...
  { id: "AQS35_1613_Anand Brahmbhatt", username: "AQS35_1613_Anand Brahmbhatt", password: "AQS35_1613", name: "Anand Brahmbhatt",    courses: ["c1"], lessonAccess: { c1: ["l2"] } },
  { id: "IQS02_1072_Alhussein Mahmoud Ali Ahmed", username: "IQS02_1072_Alhussein Mahmoud Ali Ahmed", password: "IQS02_1072", name: "Alhussein Mahmoud Ali Ahmed",    courses: ["c1"], lessonAccess: { c1: ["l2"] } },
  { id: "AQS37_1685_Aqueel", username: "AQS37_1685_Aqueel", password: "AQS37_1685", name: "Aqueel",    courses: ["c1"], lessonAccess: { c1: ["l2"] } },
  ...
  { id: "IQS02_1078_Safnas", username: "IQS02_1078_Safnas", password: "IQS02_1078", name: "Safnas",    courses: ["c1"], lessonAccess: { c1: ["l2"] } },
  { id: "APC27_1113_Shafeek Faiz", username: "APC27_1113_Shafeek Faiz", password: "APC27_1113", name: "Shafeek Faiz",    courses: ["c1"], lessonAccess: { c1: ["l2"] } },
  { id: "AQS36_1645_Dhanushka Chathuranga", username: "AQS36_1645_Dhanushka Chathuranga", password: "AQS36_1645", name: "Dhanushka Chathuranga",    courses: ["c1"], lessonAccess: { c1: ["l2"] } },
  { id: "Safardeen wahabdeen", username: "Safardeen wahabdeen", password: "IQS_009", name: "Safardeen wahabdeen",    courses: ["c1"], lessonAccess: { c1: ["l2"] } },
  { id: "Mohammed Noman", username: "Mohammed Noman", password: "IQS_010", name: "Mohammed Noman",    courses: ["c1"], lessonAccess: { c1: ["l2"] } },
  { id: "Job Tom Joseph", username: "Job Tom Joseph", password: "IQS_011", name: "Job Tom Joseph",    courses: ["c1"], lessonAccess: { c1: ["l2"] } },
  { id: "Akmal Wasifullah", username: "Akmal Wasifullah", password: "IQS_012", name: "Akmal Wasifullah",    courses: ["c1"], lessonAccess: { c1: ["l2"] } },
  { id: "Muhammad Shaban", username: "Muhammad Shaban", password: "IQS_013", name: "Muhammad Shaban",    courses: ["c1"], lessonAccess: { c1: ["l2"] } },
